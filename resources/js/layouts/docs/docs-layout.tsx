...
function Sidebar({ open, onClose, onNavigate }: SidebarProps) {
    return (
        <>
            {open && (
                <div className="fixed inset-0 z-30 bg-zinc-900/40 lg:hidden" onClick={onClose} />
            )}
            <aside
...
function TopBar({ onMenuClick, onSearchClick, dark, onToggleTheme }: TopBarProps) {
    return (
