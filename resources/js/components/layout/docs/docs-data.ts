...
export const NAV_SECTIONS: NavSectionData[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { label: 'Usage', slug: 'api-usage', path: api.usage },
            { label: 'Guideline', slug: 'api-guideline', path: api.guideline },
            { label: 'API Key', slug: 'api-api-key', path: api.apiKey },
            { label: 'Products', slug: 'api-products', path: api.products },
            { label: 'Stocks', slug: 'api-stocks', path: api.stocks },
            { label: 'Accounts', slug: 'api-accounts', path: api.accounts },
            { label: 'Activities', slug: 'api-activities', path: api.activities },
            { label: 'Errors', slug: 'api-errors', path: api.errors },
            { label: 'Pagination', slug: 'api-pagination', path: api.pagination },
