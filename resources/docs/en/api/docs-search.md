...
The following examples call the same endpoint from Python, Node.js, and PHP. Replace `YOUR_TOKEN` with a valid API token and adjust the `action` and identifiers for the operation you need.
